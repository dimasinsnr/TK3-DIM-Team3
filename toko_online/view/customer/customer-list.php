      ...
      <?php if ($customer_list != null): ?>
        ...
        foreach ($customer_list as $customer): ?>
          <tr>
            ...
            <td>
              <?php echo $customer['no_hp_customer'] ?>
            </td>
            <td>
              <?php echo $customer['alamat_customer'] ?>
            </td>
            <td class="text-center">
              <a href="submit.php?customer-edit=<?php echo $customer['id_customer'] ?>"><button
                  class="btn btn-warning">Edit</button></a>
              <a href="submit.php?customer-delete=<?php echo $customer['id_customer'] ?>"><button
