        ...
        foreach ($pembelian_list as $pembelian): ?>
          <tr>
            ...
            <td style="width:200px">
              <?php echo $pembelian['nama_supplier'] ?>
            </td>
            <td>
              <?php echo $pembelian['nama_barang'] ?>
            </td>
            <td>
              <?php echo $pembelian['jumlah_pembelian'] ?>
            </td>
            <td>
              <?php echo $pembelian['harga_beli'] ?>
            </td>
            <td>
              <?php echo $pembelian['created_at'] ?>
            </td>
            <td class="text-center">
              <a href="submit.php?pembelian-edit=<?php echo $pembelian['id_pembelian'] ?>"><button
                  class="btn btn-warning">Edit</button></a>
              <a href="submit.php?pembelian-delete=<?php echo $pembelian['id_pembelian'] ?>"><button
