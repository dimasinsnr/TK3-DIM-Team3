...
<body>
  <div class="clm-12" style="margin-top: 10px;">
    <h1>
      <?php echo $pembelianDetail != null ? "Edit Pembelian" : "Tambah Pembelian" ?>
    </h1>
  </div>
  <form action="submit.php" method="post" enctype="multipart/form-data">
    ...
    <table class="table">
      ...
      <tr>
        <td style="text-align: left;"><b>Harga Beli : </b></td>
        <td><input type="text" class="input" name="harga_beli"
            value="<?php echo $pembelianDetail != null ? $pembelianDetail[0]['harga_beli'] : '' ?>" autocomplete="off"
            required /></td>
      </tr>
      <tr>
        <td style="text-align: left;"><b>Jumlah Pembelian : </b></td>
        <td><input type="text" class="input" name="jumlah_pembelian"
            value="<?php echo $pembelianDetail != null ? $pembelianDetail[0]['jumlah_pembelian'] : '' ?>"
            autocomplete="off" required /></td>
      </tr>
      <tr>
        <td style="text-align: left;"><b>Supplier : </b></td>
        <td>
      ...
      <tr>
        <td colspan="2" style="text-align:right">
          ...
          <?php endif ?>
          <a href="?page=pembelian&&subpage=pembelian-list"><input type="button" class="btn btn-danger"
