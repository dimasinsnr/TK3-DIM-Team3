      ...
      <?php if ($supplier_list != null): ?>
        ...
        foreach ($supplier_list as $supplier): ?>
          <tr>
            ...
            <td>
              <?php echo $supplier['no_hp_supplier'] ?>
            </td>
            <td>
              <?php echo $supplier['alamat_supplier'] ?>
            </td>
            <td class="text-center">
              <a href="submit.php?supplier-edit=<?php echo $supplier['id_supplier'] ?>"><button
                  class="btn btn-warning">Edit</button></a>
              <a href="submit.php?supplier-delete=<?php echo $supplier['id_supplier'] ?>"><button
