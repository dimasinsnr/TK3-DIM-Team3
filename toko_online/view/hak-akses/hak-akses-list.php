        ...
        foreach ($hak_akses_list as $hak_akses): ?>
          <tr>
            ...
            <td style="width:200px">
              <?php echo $hak_akses['nama_akses'] ?>
            </td>
            <td>
              <?php echo $hak_akses['keterangan'] ?>
            </td>
            <td class="text-center">
              <a href="submit.php?hak-akses-edit=<?php echo $hak_akses['id_akses'] ?>"><button
                  class="btn btn-warning">Edit</button></a>
              <a href="submit.php?hak-akses-delete=<?php echo $hak_akses['id_akses'] ?>"><button
