        ...
        foreach ($penjualan_list as $penjualan): ?>
          <tr>
            ...
            <td style="width:200px">
              <?php echo $penjualan['nama_customer'] ?>
            </td>
            <td>
              <?php echo $penjualan['nama_barang'] ?>
            </td>
            <td>
              <?php echo $penjualan['jumlah_penjualan'] ?>
            </td>
            <td>
              <?php echo $penjualan['harga_jual'] ?>
            </td>
            <td>
              <?php echo $penjualan['created_at'] ?>
            </td>
            <td class="text-center">
              <a href="submit.php?penjualan-edit=<?php echo $penjualan['id_penjualan'] ?>"><button
                  class="btn btn-warning">Edit</button></a>
              <a href="submit.php?penjualan-delete=<?php echo $penjualan['id_penjualan'] ?>"><button
